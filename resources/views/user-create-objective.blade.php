        ...
        <div class="main-content">
            ...
            <div class="body d-flex flex-column align-items-center w-100">
                <div class="d-flex flex-column align-items-start w-100">
                    <h5 class="mt-3 mb-5 fw-bold">Create New Objective</h5>

                    <form class="form-perfoma d-flex flex-column align-items-start w-100" method="POST" action="{{ route('objectives.store')}}">
                        @csrf
                        ...
                        <div class="d-flex align-items-start flex-column w-50 mb-3">
                            ...
                            <textarea class="textarea-form-control" type="text" name="description"
                                id="description"></textarea>
                        </div>

                        <div class="d-flex align-items-start flex-column w-50 mb-3">
                            <label for="weight">Weight</label>
                            <input class="input-form-control" type="text" name="weight" id="weight" />
                        </div>

                        <div class="d-flex align-items-start flex-column w-50 mb-3">
                            <label for="date_debut">date_debut</label>
                            <input class="input-form-control" type="date" name="date_debut" id="period" />
                        </div>

                        <div class="d-flex align-items-start flex-column w-50 mb-3">
                            <label for="date_fin">date_fin</label>
                            <input class="input-form-control" type="date" name="date_fin" id="period" />
                        </div>

                        <div class="d-flex align-items-start flex-column w-50 mb-3">
                            <label for="value">Value</label>
                            <input class="input-form-control" type="text" name="value" id="value" />
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-column w-50 mt-5">
                            <button type="submit" class="btn-submit-form">Create</button>
                        </div>
